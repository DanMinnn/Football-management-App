...
public class Admin_Dashboard extends JFrame {
	...
	public Admin_Dashboard() {
		...
		panel_Coso1.setBounds(0, 170, 190, 60);
		panel_menu.add(panel_Coso1);
		panel_Coso1.setLayout(null);
		
		JLabel lb_Coso_1 = new JLabel("CƠ SỞ ");
		...
		panel_Coso2.setBounds(0, 290, 190, 60);
		panel_menu.add(panel_Coso2);
		panel_Coso2.setLayout(null);
		
		JLabel lb_Coso_2 = new JLabel("THÊM CƠ SỞ");
		...
		lb_Coso_2.setBounds(55, 10, 110, 40);
		...
		panel_Coso3.setBackground(new Color(0, 128, 0));
		...
		panel_Coso3.setBounds(0, 230, 190, 60);
		...
		lb_Coso_3.setBounds(56, 10, 110, 40);
		...
		panel_signout.setBounds(0, 650, 190, 60);
		...
		JPanel panel_Coso3_1 = new JPanel();
		panel_Coso3_1.setLayout(null);
		panel_Coso3_1.setBorder(new LineBorder(new Color(192, 192, 192)));
		panel_Coso3_1.setBackground(new Color(0, 128, 0));
		panel_Coso3_1.setBounds(0, 350, 190, 60);
		panel_menu.add(panel_Coso3_1);
		...
		lb_Coso_3_1.setBounds(56, 10, 110, 40);
		panel_Coso3_1.add(lb_Coso_3_1);
		Image icon_kh = new ImageIcon(this.getClass().getResource("/khach hang.png")).getImage();
		JLabel lblNewLabel_2_1_1 = new JLabel("");
		lblNewLabel_2_1_1.setIcon(new ImageIcon(icon_kh));
		lblNewLabel_2_1_1.setForeground(Color.WHITE);
		lblNewLabel_2_1_1.setBounds(20, 10, 38, 40);
		panel_Coso3_1.add(lblNewLabel_2_1_1);
