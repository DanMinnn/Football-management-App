...
public class coso_controll extends JPanel {
	...
	private JComboBox<String> jcombo_ma_san;
	private JComboBox<String> jcombo_ls;
	private JComboBox<String> jcombo_trang_thai;
	...
	public coso_controll() {
		...
		JLabel lb_maCS = new JLabel("Mã sân:");
		lb_maCS.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lb_maCS.setBounds(20, 50, 69, 27);
		pn_TT_san.add(lb_maCS);

		DefaultComboBoxModel comboModel_ms = new DefaultComboBoxModel();
		comboModel_ms.addElement("1");
		comboModel_ms.addElement("2");
		comboModel_ms.addElement("3");

		jcombo_ma_san = new JComboBox(comboModel_ms);
		jcombo_ma_san.setFont(new Font("Tahoma", Font.PLAIN, 16));
		jcombo_ma_san.setBounds(110, 50, 97, 27);
		pn_TT_san.add(jcombo_ma_san);
		...
		DateEditor de1 = new DateEditor(txt_gio_da, "dd/MM/yyyy HH:mm");
		txt_gio_da.setEditor(de1);
		txt_gio_da.setFont(new Font("Tahoma", Font.PLAIN, 16));
		txt_gio_da.setBounds(110, 172, 174, 27);
		...
		DateEditor de2 = new DateEditor(txt_gio_nghi, "dd/MM/yyyy HH:mm");
		txt_gio_nghi.setEditor(de2);
		txt_gio_nghi.setFont(new Font("Tahoma", Font.PLAIN, 16));
		txt_gio_nghi.setBounds(110, 212, 174, 27);
		...
		jcombo_trang_thai = new JComboBox(comboModel_tt);
		jcombo_trang_thai.setFont(new Font("Tahoma", Font.PLAIN, 16));
		jcombo_trang_thai.setBounds(403, 90, 107, 27);
		pn_TT_san.add(jcombo_trang_thai);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				list = san_bong_dao.getInterface()
						.select_by_condition("ma_san='" + jcombo_CS.getItemAt(jcombo_CS.getSelectedIndex()) + "'");
				model = (DefaultTableModel) table.getModel();
				model.setRowCount(0);
				showTable();
			}
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				switch (co_so) {
				case "1":
					jcombo_ma_san.setSelectedIndex(0);
					break;
				case "2":
					jcombo_ma_san.setSelectedIndex(1);
					break;
				case "3":
					jcombo_ma_san.setSelectedIndex(2);
					break;
				...
				String trang_thai = model_table.getValueAt(i, 6).toString();
		...
		model.setColumnIdentifiers(
				new Object[] { "STT", "Mã cơ sở", "Tên sân", "Loại sân", "Ngày đá", "Thời gian", "Trạng thái" });
	}

	public void showTable() {
		int i = 1;
		for (san_bong sb : list) {
			model.addRow(new Object[] { i++, sb.getMa_San(), sb.getTen_san(), sb.getLoai_san(), sb.getNgay_da(),
