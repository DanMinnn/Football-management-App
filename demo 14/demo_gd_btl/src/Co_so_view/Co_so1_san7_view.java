...
public class Co_so1_san7_view extends JPanel {
	...
	public Co_so1_san7_view() {
		...
		JLabel lblNewLabel_3 = new JLabel(" DS Sân bóng 7  Cơ sở 1 người ngày hôm nay");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel_3.setBounds(10, 0, 448, 34);
		...
		list_sb= san_bong_dao.getInterface().select_by_condition("iD_CoSo = 1 and LoaiSan = '7 người'");
	...
	public void showTable() {
		list = dat_san_dao.getInterface().select_by_condition("iD_CoSo = 1 and LoaiSan = '7 người'");
		int i = 1;
		DefaultTableModel model = (DefaultTableModel) table.getModel();
		for (dat_san ds : list) {
