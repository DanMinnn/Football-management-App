...
public class Co_so3_san5_view extends JPanel {
	...
	public Co_so3_san5_view() {
		...
		list = san_bong_dao.getInterface().select_by_condition("ma_san = 1 and loai_san= '5 người'");
		...
		model.setColumnIdentifiers(new Object[] { "STT", "Mã sân","Tên sân", "Ngày đá", "Thời gian","Khách hàng" });
		showTable();
		//// ________________________________________
