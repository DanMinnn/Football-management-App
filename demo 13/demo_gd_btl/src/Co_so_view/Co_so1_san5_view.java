...
public class Co_so1_san5_view extends JPanel {
	...
	public Co_so1_san5_view() {
		...
		list = san_bong_dao.getInterface().select_by_condition("maCS = 1 and loai_san = '5 người'");
		...
		model.setColumnIdentifiers(new Object[] { "STT", "Mã sân","Tên sân","Ngày đá","Khách hàng" });
		showTable();
		//// ________________________________________
		...
		ngay_da.setBounds(109, 135, 146, 27);
		panel.add(ngay_da);
		...
		txt_gio_da.setBounds(110, 180, 120, 27);
		...
		txt_gio_nghi.setBounds(110, 210, 120, 27);
...
//			model.addRow(new Object[] { i++, sb.getMa_San(),sb.getTen_san(), sb.getNgay_da(), sb.getThoi_gian_da(),
//					});
//		}
