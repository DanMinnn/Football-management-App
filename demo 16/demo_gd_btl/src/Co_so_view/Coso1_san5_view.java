...
public class Coso1_san5_view extends JPanel {
	...
	public Coso1_san5_view() {
		...
		model.setRowCount(0);
		model.setColumnIdentifiers(new Object[] { "STT","Mã sân","Tên sân", "Loại sân", "Thời gian", "Khách hàng"});
...
//			model.addRow(new Object[] { i++,sb.getMa_San(),sb.getTen_san(), sb.getNgay_da(),
//					sb.getThoi_gian_da() });
//	    }
	}
