	...
	public Co_so2_san5_view() {
		setBackground(new Color(128, 128, 128));
		  ...
		  //// ________________________________________
			...
			JLabel lblNewLabel_3 = new JLabel(" Danh sách sân bóng 5 người cơ sở 2");
			lblNewLabel_3.setFont(new Font("Tahoma", Font.PLAIN, 20));
			lblNewLabel_3.setBounds(10, 0, 350, 34);
			panel_2.add(lblNewLabel_3);
            
			list = san_bong_dao.getInterface().select_by_condition("maCS = 2 and loai_san= 5");
			...
			scrollPane.setBounds(0, 35, 746, 194);
			add(scrollPane);
			...
			panel_1.setBackground(new Color(0,206,0));
