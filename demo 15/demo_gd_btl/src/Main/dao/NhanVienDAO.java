...
public class NhanVienDAO implements Dao_interface<NhanVien>{
	...
	public int insert(NhanVien t) {
		...
		try {
			String sql = "INSERT INTO nhanvien (iD_NhanVien, HoTen, GioiTinh ,NamSinh, SDT, DiaChi)"
					+ "VALUES (?,?,?,?,?,?)";
			...
			JOptionPane.showMessageDialog(null,"Mã sinh viên "+t.getID()+" đã tồn tại","Thông Báo",1);
			e.printStackTrace();
