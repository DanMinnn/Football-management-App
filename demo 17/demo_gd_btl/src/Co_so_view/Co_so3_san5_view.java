...
public class Co_so3_san5_view extends JPanel {
	...
	public Co_so3_san5_view() {
		...
		JLabel lblNewLabel_3 = new JLabel(" DS đặt sân bóng 5 người Cơ sở 3");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel_3.setBounds(10, 0, 402, 34);
		...
		lb_ten_san.setBounds(313, 124, 79, 27);
		panel.add(lb_ten_san);


		list_sb = new ArrayList<>();
		list_sb= san_bong_dao.getInterface().select_by_condition("iD_CoSo = 3 and LoaiSan = '5 người'");
		...
		jcombo_ten_san.setBounds(402, 124, 146, 30);
		...
		txt_gio_nghi.setBounds(109, 198, 146, 27);
		...
		bt_dat_san.setBounds(373, 260, 97, 46);
		...
		bt_huy_san.setBounds(480, 260, 97, 46);
		...
		bt_tim_san.setBounds(257, 260, 106, 46);
		...
		btn_thanhToan.setBounds(587, 260, 149, 46);
		panel.add(btn_thanhToan);
		
	}

	public void showTable() {
		list = dat_san_dao.getInterface().select_by_condition("iD_CoSo = 3 and LoaiSan = '5 người'");
		int i = 1;
		DefaultTableModel model = (DefaultTableModel) table.getModel();
		for (dat_san ds : list) {
