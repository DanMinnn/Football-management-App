...
public class Co_so2_san7_view extends JPanel {
	...
	public Co_so2_san7_view() {
		...
		JLabel lblNewLabel_3 = new JLabel(" DS đặt sân bóng 7 người Cơ sở 2");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel_3.setBounds(10, 0, 422, 34);
		...
		list_sb= san_bong_dao.getInterface().select_by_condition("iD_CoSo = 2 and LoaiSan = '7 người'");
		...
		jcombo_ten_san.setBounds(412, 126, 146, 30);
		...
		bt_dat_san.setBounds(375, 260, 97, 46);
		...
		bt_huy_san.setBounds(482, 260, 97, 46);
		...
		bt_tim_san.setBounds(259, 260, 106, 46);
		...
		btn_thanhToan.setBounds(589, 260, 147, 46);
		panel.add(btn_thanhToan);
		
	}

	public void showTable() {
		list = dat_san_dao.getInterface().select_by_condition("iD_CoSo = 2 and LoaiSan = '7 người'");
		int i = 1;
		DefaultTableModel model = (DefaultTableModel) table.getModel();
		for (dat_san ds : list) {
